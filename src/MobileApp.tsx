...
function MobileNewsSection() {
  ...
  return (
    <section className="mobile-news-section">
      {/* Snake-game-like scrolling text header */}
      <div className="mobile-news-scroll-header">
        <div className="mobile-news-scroll-text">
          Latest News • Swipe to Explore • Breaking Updates • Crypto Trends • Market Insights • Latest News • Swipe to Explore • Breaking Updates • Crypto Trends • Market Insights •
        </div>
      </div>
